package com.example.screenddisplay;

import androidx.appcompat.app.AppCompatActivity;
import android.os.Bundle;
import android.widget.TextView;
import com.example.screenddisplay.util.DisplayUtil;
import com.example.screenddisplay.util.Utils;
...
private TextView text_screen;
    ...
    private void showScreenInfo(){
      int width = DisplayUtil.getScreenWidth(this);
       int hight = DisplayUtil.getScreenHeight(this);
       float sensity = DisplayUtil.getScreenDensity(this);
        String info = String.format("当前屏幕的宽度是%dpx，高度是%dpx，像素密度是%f",width,hight,sensity);
